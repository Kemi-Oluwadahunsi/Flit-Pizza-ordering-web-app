...
const BlogPage = () => {
  return (
    <div className="pageMargin  pb-20">
      <div className="flex justify-evenly mx-24 gap-14">
        <div className="flex-1">
          <h1 className="text-4xl font-extrabold">
            The Irresistible Pleasure of Pizza: A Culinary Delight
          </h1>
          <div className={`w-full mt-10 border ${styles.blogBackground}`}></div>
          ...
          <div className="flex flex-col gap-5 mt-10">
            ...
            <h3 className="font-bold text-2xl">Cheese: Gooey Goodness</h3>
            ...
            <h3 className="font-bold text-2xl">Toppings: A Personal Touch</h3>
            ...
            <h2 className="font-bold text-3xl">The Art of Eating Pizza</h2>

            <h3 className="font-bold text-2xl">1. Embrace the Fold</h3>
            ...
            <h3 className="font-bold text-2xl">3. Savor Slowly</h3>
