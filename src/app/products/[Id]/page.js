...
const ProductPage = () => {
  ...
  return (
    <>
      <section className="flex flex-col lg:flex-row gap-20 pageMargin">
        <section className=" h-full lg:w-2/4 pt-15">
          <div className="flex lg:flex-1 h-full items-center justify-center relative lg:border">
            <Image
              src={pizza1.img}
        ...
        <section className=" -mt-10  lg:pt-3 text-center lg:text-start lg:w-2/4">
          ...
          <div className="flex h-32 lg:w-2/4 justify-around lg:justify-between align-middle mt-2 lg:mt-0">
            ...
            >
              <span className="absolute bg-red-500 left-7 text-xs lg:text-sm rounded-xl px-1 border border-black text-white">
                Small
              </span>
              <Image
            ...
            >
              <span className="absolute bg-red-500 left-8 text-xs lg:text-sm rounded-xl px-1 border border-black text-white">
                Medium
              </span>
              <Image
                src="/images/pizza-size.svg"
            ...
            >
              <span className="absolute bg-red-500 left-12 text-xs lg:text-sm rounded-xl px-1 border border-black text-white">
                Large
              </span>
              <Image
                src="/images/pizza-size.svg"
